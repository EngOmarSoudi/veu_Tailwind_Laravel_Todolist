...
<!--                        <p v-show="taskErorrs.title" class="text-red-500 text-xs italic">Please fill out this field.</p>-->
                        ...
                        <vee-field v-model="date" name="date" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="date" placeholder="Doe"/>
<!--                            <vee-field  v-model="date" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="date" placeholder="Doe" />-->
<!--                            <p v-show="taskErorrs.date" class="text-red-500 text-xs italic">Please fill out this field.</p>-->
                            <error-message name="date"  class="text-red-500 text-xs italic"></error-message>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
